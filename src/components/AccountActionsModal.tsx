    ...
    <AnimatePresence>
      {isOpen && account && (
        <motion.div
          ...
          exit={{ opacity: 0 }}
          onClick={onClose}
          className="fixed inset-0 bg-black/40 backdrop-blur-md flex items-end justify-center z-50"
        >
          <motion.div
            initial={{ y: "100%" }}
            animate={{ y: 0 }}
            ...
            className="bg-zinc-900 w-full max-w-4xl rounded-t-3xl p-4 border-t border-zinc-800/60"
          >
