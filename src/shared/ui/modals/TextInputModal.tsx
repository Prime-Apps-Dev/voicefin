    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0 bg-black/40 backdrop-blur-md flex flex-col justify-end items-center z-50"
          onClick={onClose}
        >
          <motion.div
            initial={{ y: "100%" }}
            ...
            className="bg-zinc-900 rounded-t-3xl shadow-xl w-full max-w-2xl border-t border-zinc-800/60"
