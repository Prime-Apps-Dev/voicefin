    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="bg-zinc-900 rounded-2xl w-full max-w-sm border border-zinc-800 overflow-hidden relative"
        ...
        >
          ...
          <div className={`h-32 w-full ${isIOwe ? 'bg-gradient-to-br from-red-900/50 to-black' : 'bg-gradient-to-br from-emerald-900/50 to-black'} relative`}>
            ...
            <div className="absolute -bottom-8 left-1/2 -translate-x-1/2">
                <div className={`w-20 h-20 rounded-full border-4 border-zinc-900 flex items-center justify-center text-3xl font-bold shadow-xl ${
                    isIOwe ? 'bg-red-500 text-white' : 'bg-emerald-500 text-white'
                }`}>
          ...
          <div className="pt-10 pb-6 px-6 text-center">
            ...
            <div className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold mb-4 ${
                 isIOwe ? 'bg-red-500/10 text-red-400' : 'bg-emerald-500/10 text-emerald-400'
            }`}>
